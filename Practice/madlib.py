...
story = "\n" + user_inputs["name"] + " was making a " + user_inputs["cookable"] + ". " + user_inputs["pronoun_regular"] + " has always enjoyed a good " + user_inputs["cookable"] + " on a " + user_inputs["day_describer"] + " day. Luckily " + user_inputs["name"] + " has always felt that times like this were perfect for turtle " + user_inputs["actions"] + ". Although many people found " + user_inputs["pronoun_possessive"] + " morning activities extroardinarily peculiar " + user_inputs["name"] + " still enjoyed every second of it. For they had lived " + user_inputs["age"] + " years, enough to give the maturity to understand how important doing the tasks you love is."
