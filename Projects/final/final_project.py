...
locations = {
    ...
    "lumray_village" :{
        ...
        "3B" : {
            ...
            "connections": (["lumray_village","2B"],['lumray_vilage',"1B"])
...
def roomFunc(biom, room):
    ...
    if biom != 0 or 1:
        ...
        if locations[biom][room]["events"] == False:
            ...
            if bool(locations[biom][room]["events"]["collectable"]) == True:
                if bool(locations[biom][room]["events"]["collectable"]["stat"]) == True and locations[biom][room]["events"]["collectable"]["stat"]["collected"] == False:
                    ...
                    rin["lanterns"][locations[biom][room]["events"]["collectable"]["light"]['light']]["owned"] = True
        ...
        while True:
            choice = input("if you would like to play again press 1 if not press 2")
            if choice == "1":
                pass#call restrat function
            elif choice == "2":
                roomFunc(0,0)
